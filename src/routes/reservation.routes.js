...
import { isMerchant, isTraveler, requireAuth, validateId } from '../middlewares/auth.middleware.js'
...
router.post('/restaurant/:id', requireAuth, isTraveler, validateId, reservationController.POSTReservation)  // Viajero crea una reserva
  .put('/:id/cancel', requireAuth, isTraveler, validateId, reservationController.PUTReservationCancel)  // Viajero cancela su reserva
